...
import stoveRepairData from './StoveRepairData.json'
        ...
        <div className='row py-5 gx-3'>
            ...
            <div className="col-md-3 d-flex justify-content-center align-items-center bg-light rounded shadow">
                <div className='bg-light p-3 rounded shadow'>
                    <p className='fs-4 fw-bold lh-1 mb-2'>Oven <span style={{color: '#0073dd'}} className=' for_font_family'>&</span> Stove repair</p>
...
export default StoveRepairSection;